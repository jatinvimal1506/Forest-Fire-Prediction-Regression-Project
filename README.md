...
Forest fires cause massive environmental damage. This project uses meteorological data (temperature, humidity, wind speed, rain) to predict the Fire Weather Index, which indicates fire risk levels.
...
```bash
git clone https://github.com/jatinvimal1506/Forest-Fire-Prediction-Regression-Project.git
